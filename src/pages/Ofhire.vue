              ...
              <template v-slot:item.estado="{ item }">
                ...
                <v-toolbar flat color="indigo lighten-4">
                    ...
                    <template v-slot:activator="{ on }">
                        <v-btn color="success" small class="mb-1" v-on="on"> Off-Hire</v-btn>
                    </template>
                    <v-card>
                        <v-card-title>
                        ...
                        <v-container>
                            ...
                            <v-col cols="12" sm="4" md="4">
                             ...
                             <v-col cols="12" sm="4" md="4">
                              ...
                              <v-col cols="12" sm="4" md="4">
                               <v-datetime-picker label="Horario de ON-HIRE" locale="es" v-model="ofhire"> </v-datetime-picker>
                            </v-col>
                             <v-col cols="12" sm="4" md="4">
...
export default {
  ...
  components: {
   ...
   computed:{
     formTitle () {
      return this.editedIndex === -1 ? 'Nuevo Of-Hire' : 'Editar Of-Hire'
    },
    },
   ...
   selectServicios(){
      ...
      listar(){
          let me=this
           let header={"Token":this.$store.state.token};
           let configuracion= {headers: header}
          axios.get('ofhire/list',configuracion).then(function (response){
