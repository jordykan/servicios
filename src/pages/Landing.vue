  ...
  <div>
    <div class="page-header page-header-small">
      <parallax
        ...
        style="background-image: url('img/fondo_p.jpg')"
      >
      </parallax>
      <div class="content-center">
        <div class="container">
          <h1 class="title">Agencia Consignataria y Fletamento de Embarcaciones</h1>
          <div class="text-center">
            <a href="#pablo" class="btn btn-blue btn-icon btn-round">
        ...
        <div class="row">
          <div class="col-md-8 ml-auto mr-auto text-center">
            ...
            <h5 class="description">
              AMLS es una empresa marítima 100% mexicana que presta servicios a la industria global del sector energético.

Nuestras soluciones en servicios abarcan la transportación marítima, agencia consignataria, la logística costa fuera y terrestre. Fortalecemos el conocimiento y la experiencia de nuestros clientes, asegurando así las decisiones de calidad. 
            </h5>
          </div>
        </div>
